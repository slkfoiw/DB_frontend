    ...
    <div class="stu-data-analysis">
      <el-card>
        ...
        <div class="header">
          ...
          <div class="actions">
            <el-button @click="exportChart" v-if="chartType === 'bar' || chartType === 'pie'">导出图像</el-button>
        ...
        <div class="drilldown" v-if="!drilldownMode">
          <el-select v-model="drilldownBuilding" placeholder="选择公寓楼" @change="fetchDrilldownData">
            <el-option v-for="building in stats" :key="building.buildingId" :label="building.buildingId" :value="building.buildingId"></el-option>
          </el-select>
        </div>
        ...
        <div class="drilldown" v-if="drilldownMode">
          <el-select v-model="drilldownDepartment" placeholder="选择系号" @change="fetchDrilldownData2">
            <el-option v-for="item in drilldownData" :key="item.department" :label="item.department" :value="item.department"></el-option>
          </el-select>
        </div>
